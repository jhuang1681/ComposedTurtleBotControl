Report of our findngs under `report.pdf`.
...
In a seperate terminal, activate and setup your virtual environment and run the following
```
...
```
Additionally, to run the trianing off a previously trained model, you can add the following argument
```
